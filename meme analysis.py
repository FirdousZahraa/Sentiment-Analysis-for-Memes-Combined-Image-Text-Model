...
labels = pd.read_csv('/content/drive/MyDrive/archive/memotion_dataset_7k/labels.csv')
...
dataset = MemeSentimentDataset(csv_file = data_used, root_dir = '/content/drive/MyDrive/archive/memotion_dataset_7k/images', transform = transform)
